...
export class TokenTradedHandler extends SocketHandler {
	async handle({ username, profilePicture, tokenInAmount, tokenInName, tokenInDecimals, tokenInImageUrl, tokenOutAmount, tokenOutDecimals, tokenOutName, tokenOutImageUrl }: TokenTradedEvent) {
		try {
